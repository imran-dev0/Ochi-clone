...
function Navbar() {
  ...
  return (
    <div className='z-[999] w-full px-5 md:px-20 py-6 md:py-8 font-["Neue Montreal"] flex justify-between items-center relative'>
...
          ></path>
        ...
        {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
          (item, index) => (
            <motion.a
              ...
              className="relative text-lg capitalize font-light hover:underline hover:underline-offset-8"
            >
              {item}
            </motion.a>
          )
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-zinc-800 flex flex-col items-center gap-4 py-4 shadow-lg md:hidden">
          {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
            (item, index) => (
              <motion.a
                key={index}
