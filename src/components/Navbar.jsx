...
function Navbar() {
  return (
    <div className='fixes z-[999] w-full px-20 py-8 font-["Neue Montreal"] flex justify-between items-centre'>
      <div className="logo">
        <svg
          width="72"
          height="30"
  ...
  {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
    (item, index) => (
      <motion.a
        ...
        className={`relative text-lg capitalize font-light transition-all duration-300 
          hover:underline hover:underline-offset-8 hover: ${
            index === 4 ? "ml-32" : ""
          }`}
      >
        {item}
