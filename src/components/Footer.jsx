...
function Footer() {
  return (
    <div className='w-full min-h-screen bg-zinc-900 px-4 sm:px-8 md:px-16 py-10 flex flex-col lg:flex-row gap-10 font-["Founders Grotesk X-Condensed"]'>
      {/* Left Side */}
      <div className='w-full lg:w-1/2 flex flex-col justify-between'>
        <div>
          <h1 className='text-[7vw] sm:text-[8vh] md:text-[10vh] uppercase leading-none font-semibold'>Eye-</h1>
          <h1 className='text-[7vw] sm:text-[8vh] md:text-[10vh] uppercase leading-none font-semibold'>Opening</h1>
        </div>
      ...
      <div className='w-full lg:w-1/2'>
        <h1 className='text-[7vw] sm:text-[8vh] md:text-[10vh] uppercase leading-none font-semibold'>Presentations</h1>
        <div className='dets flex flex-col font-["Neue_Montreal"] mt-8 sm:mt-10 gap-6'>
          <div className='flex flex-col'>
            <p className='mb-2 sm:mb-4'>S :</p>
            <a className="mb-1" href="#">Instagram</a>
            <a className="mb-1" href="#">Behance</a>
            <a className="mb-1" href="#">Facebook</a>
            <a className="mb-1" href="#">LinkedIn</a>
          </div>
          <div className='flex flex-col'>
            <p className='mt-2 sm:mt-4'>L :</p>
            <a className='mt-2' href="#">202-1965 W 4th Ave<br />Vancouver, Canada </a>
            <a className='mt-2' href="#">30 Chukarina St<br />Lviv, Ukraine</a>
          </div>
          <div>
            <p className='mb-2 mt-2 sm:mb-3 sm:mt-4'>E :</p>
