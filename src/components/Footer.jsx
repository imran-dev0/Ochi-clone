...
function Footer() {
  return (
    <div className='flex gap-30  w-full h-screen bg-zinc-900 p-16 font-["Founders Grotesk X-Condensed"]'>
        <div className='w-1/2 h-full flex flex-col justify-between  '>
       <div>
         <h1 className='text-[10vh] uppercase leading-none font-semibold '>Eye-</h1>
        <h1 className='text-[10vh] uppercase leading-none font-semibold '>Opening</h1>
       </div>
        ...
        <div className='w-1/2'>
        <h1 className='text-[10vh] uppercase leading-none font-semibold '>Presentations</h1>
        <div className='dets flex flex-col font-["Neue_Montreal"] mt-10 '>
          ...
          <a href="#">LinkedIn</a>
           ...
           <div className='flex flex-col'>
             <p className='mt-4'>L :</p>
          <a className='mt-4' href="#">202-1965 W 4th Ave
Vancouver, Canada </a>
             <a className='mt-2' href="#">30 Chukarina St
Lviv, Ukraine</a>
           </div >
            <div>
              <p className='mb-3 mt-4'>E  :</p>
